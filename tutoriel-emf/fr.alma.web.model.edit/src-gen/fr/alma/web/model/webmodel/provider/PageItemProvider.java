...
/**
 * This is the item provider adapter for a {@link fr.alma.web.model.webmodel.Page} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addTitlePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Page_title_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Page_title_feature", "_UI_Page_type"),
						WebmodelPackage.Literals.PAGE__TITLE, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebmodelPackage.Literals.PAGE__ARTICLES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case WebmodelPackage.PAGE__TITLE:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case WebmodelPackage.PAGE__ARTICLES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(WebmodelPackage.Literals.PAGE__ARTICLES,
				WebmodelFactory.eINSTANCE.createArticle()));
	}
